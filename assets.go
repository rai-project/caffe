// Code generated by fileb0x at "2018-12-05 14:26:04.865786 -0600 CST m=+0.038257495" from config file "b0x.yml" DO NOT EDIT.
// modification hash(b027fdb61ffe62b2ba4b504bace34ab9.a5bbc47c2ec1d6c07ec79d2a897f3d61)
...
func init() {
	...
	rb = bytes.NewReader(FileShufflenet1xG3Yml)
	r, err = gzip.NewReader(rb)
	if err != nil {
		panic(err)
	}
	...
	f, err = FS.OpenFile(CTX, "/shufflenet_1x_g3.yml", os.O_RDWR|os.O_CREATE|os.O_TRUNC, 0777)
	if err != nil {
		panic(err)
	}
