...
// builtin_models/VGG-ILSVRC-16.yml
// builtin_models/VGG-ILSVRC-19.yml
...
func vggIlsvrc19Yml() (*asset, error) {
	bytes, err := vggIlsvrc19YmlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "VGG-ILSVRC-19.yml", size: 2249, mode: os.FileMode(420), modTime: time.Unix(1502662533, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"VGG-ILSVRC-16.yml": vggIlsvrc16Yml,
	"VGG-ILSVRC-19.yml": vggIlsvrc19Yml,
...
var _bintree = &bintree{nil, map[string]*bintree{
	...
	"VGG-ILSVRC-16.yml": &bintree{vggIlsvrc16Yml, map[string]*bintree{}},
	"VGG-ILSVRC-19.yml": &bintree{vggIlsvrc19Yml, map[string]*bintree{}},
